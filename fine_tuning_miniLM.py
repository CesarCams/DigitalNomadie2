...
trainer.save_model("./fine_tuned_twitter_miniLM")
tokenizer.save_pretrained("./fine_tuned_twitter_miniLM")
...
model = AutoModelForSequenceClassification.from_pretrained("./fine_tuned_twitter_miniLM")
tokenizer = AutoTokenizer.from_pretrained("./fine_tuned_twitter_miniLM")
...
create_csv_submission(ids, labels, "data/submission_fully_fine_tuned_miniLM.csv")
